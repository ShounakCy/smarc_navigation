...
class SamACC(object):
    ...
    def __init__(self):
        ...
        self.control_pub_copy = rospy.Publisher(self.dr_thrust_topic, TwistStamped, queue_size=10)
    ...
    def timerCB(self, ev):
        ...
        self.control_pub_copy.publish(twist_msg)


if __name__ == "__main__":

    rospy.init_node('sam_am_copy')
    try:
        SamACC()
